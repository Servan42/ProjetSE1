...
public class ProdCons implements Tampon {
	...
	/**
	 * Methode permettant au Consommateur de recuperer un exemplaire d'un
	 * message dans le tampon. Recupère le message le plus ancien du tampon, et
	 * met la case du tampon à <code>null</code> après recuperation
	 * 
	 * @param arg0
